    ...
    var run = function(){
        ...
        Jingle.launch({
            ...
            remotePage : {
                ...
                '#import_section' : 'remote/import_section.html',
                '#wallet_section' : 'remote/wallet_section.html',
                '#localstorage_section' : 'remote/localstorage_section.html'
            }
        });
...
App.page('refresh',function(){
    this.init = function(){
        J.Refresh({
            ...
            type : 'pullDown',
            pullText : lang?translation['下拉...'][transindex[lang]]:'下拉...',
            releaseText : lang?translation['放手刷新...'][transindex[lang]]:'放手刷新...',
